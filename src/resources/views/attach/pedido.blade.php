...
<table cellspacing="0" border="0">
	<tr>
		<td colspan="2" rowspan=6 height="10" align="center" valign=bottom>
			{{-- <img src="/img/wb.png" width=115 height=92 hspace=9 vspace=18> --}}
		</td>
	...
	<tr>
		<td height="10" colspan="7" align="left" valign="bottom"><font color="#3B3838">Av. Santa Maria 135 Urb. Industrial la Aurora Ate-Lima-Perú</font></td>
	...
	<tr>
		<td height="10" colspan="7" align="left" valign="bottom"><font color="#3B3838">Telef. 01 2002900</font></td>
		...
		<td style="border-top: 2px solid #000000; border-bottom: 2px solid #000000; border-left: 2px solid #000000; border-right: 2px solid #000000" colspan="2" align="right" valign="bottom"><b>{{$mcodven}}</b></td>
	</tr>
	<tr>
		<td height="10" colspan=7 align="left" valign=bottom>E-mail: televentasfiltros@willybusch.com.pe</td>
    ...
    <td colspan="1" height="10" align="left" valign=middle><b>:</b></td>
		<td colspan="8" align="left" valign=middle><b><font color="#2E75B6">{{$direccion}}</font></b></td>
		<td align="left" valign=bottom><br></td>
		<td align="left" valign=bottom><br></td>
		<td align="left" valign=bottom bgcolor="#FFFFFF"><font color="#FFFFFF"><br></font></td>
	</tr>
  ...
  <tr>
	...
	@if ($articulo['MCODDFA'] != 'Bono')
	<tr>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan="2" align="left" valign=bottom>{{$articulo['MCODART']}}</td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan="4" align="left" valign=bottom><b>{{$articulo['MDESCRI01']}}</b></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan="2" align="right" valign=bottom sdval="10" sdnum="1033;"><b>{{$articulo['MCANTIDAD']}}</b></td>
      ...
      {{number_format($articulo['MPRECIO'], 2, '.', '')}}
		</td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan="3" align="left" valign=bottom>{{$articulo['MDESCRIP']}}</td>
    <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan="2" align="right" valign=bottom sdval="1449.23184" sdnum="1033;0;0.00_ ;[RED]-0.00 ">
      <b>
        {{number_format($articulo['MVALVEN'] - $articulo['MDCTO'], 2, '.', '')}}
      </b>
    </td>
	</tr>
	@else
	<tr>
		...
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan="4" align="left" valign=bottom><b>{{$articulo['MDESCRI01']}}</b></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan="2" align="right" valign=bottom sdval="10" sdnum="1033;"><b>{{$articulo['MCANTIDAD']}}</b></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan="1" align="right" valign=bottom sdval="144.923184" sdnum="1033;0;0.00_ ;[RED]-0.00 ">0.00</td>
    ...
    <td style="border-top: 2px solid #000000; border-bottom: 2px solid #000000; border-left: 2px solid #000000; border-right: 2px solid #000000" colspan="3" align="right" valign=bottom>
      <b>
        <font size=3>S/   {{number_format($total, 2, '.', '')}}</font>
      </b>
    </td>
	</tr>
	<tr>
